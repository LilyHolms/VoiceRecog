...
void VoiceMain::MyMain()
{
	...
	const char* login_params = "appid = 58bbd9c3, work_dir = ."; // 登录参数，appid与msc库绑定,请勿随意改动
	int aud_src = 0;
	...
	*/
	...
	//	demo_file("wav/siyixia.wav", session_begin_params);
	//}
	//exit:
	//	printf("按任意键退出 ...\n");
	//	_getch();
